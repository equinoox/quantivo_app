...
import { SETUP_ALREADY_COMPLETED_ERROR } from "@/features/setup/services/setup.service";
...
export function SetupFinalizingScreen() {
  ...
  const finalize = async () => {
    ...
    if (!result.ok) toast.error(t("setupFailed"), result.error === SETUP_ALREADY_COMPLETED_ERROR ? t("setupAlreadyCompleted") : result.error);
  };
