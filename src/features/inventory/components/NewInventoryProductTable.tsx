...
export function NewInventoryProductTable({ canEditProductFieldForProduct, formatMoney, getProductInventoryValue, groupedProducts, onOpenCell, showLowStockWarning = false, t }: NewInventoryProductTableProps) {
                  ...
                  <RevealOnScroll key={product.id} duration={560}>
                    <View className={clsx("flex-row items-center bg-white", !isLastRow && "border-b border-primary")}>
                      ...
                      <View style={{ width: tableColumns[2].width }} className="justify-center px-2 py-3">
                        <Pressable disabled={!canEditProductFieldForProduct(product, "quantity")} onPress={() => onOpenCell(product.id, "quantity")} className="min-h-10 justify-center rounded-md border border-primary bg-background px-2">
                      ...
                      <View style={{ width: tableColumns[3].width }} className="justify-center px-2 py-3">
                        <Pressable disabled={!canEditProductFieldForProduct(product, "entered")} onPress={() => onOpenCell(product.id, "entered")} className="min-h-10 justify-center rounded-md border border-primary bg-background px-2">
                      ...
                      <View style={{ width: tableColumns[4].width }} className="justify-center px-2 py-3">
                        <Pressable disabled={!canEditProductFieldForProduct(product, "end")} onPress={() => onOpenCell(product.id, "end")} className="min-h-10 justify-center rounded-md border border-primary bg-background px-2">
